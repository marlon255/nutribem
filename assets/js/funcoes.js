...
$(document).ready(function(){
	...
	/*$("#produto_local").blur(function(){
		$.ajax({
			url: "pags/busca_combustivel.php",
			dataType: "json",	
			data: {
			    produto: $('#produto_local').val()
			},
			success: function( teste ) {
			   $('#pergunta_combustivel').val(teste);
			}
		});
	});*/
	...
	$("#money1").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
	$("#money2").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
	$("#money3").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
	$("#money4").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
	$("#money5").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
	$("#money6").maskMoney({showSymbol:true, symbol:"R$", decimal:",", thousands:"."});
});